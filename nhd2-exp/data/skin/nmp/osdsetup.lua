...
function main()
	...
	item3:setHint(neutrino.LOCALE_COLORMENU_THEMESELECT)
	...
	item4:setHint(neutrino.LOCALE_COLORMENU_THEMESELECT)
	...
	item5:setHint(neutrino.LOCALE_COLORMENU_THEMESELECT)
	...
	item6:setHint(neutrino.LOCALE_COLORMENU_THEMESELECT)
	...
	item8:setHint(neutrino.LOCALE_COLORMENU_THEMESELECT)
	...
	item9:setHint(neutrino.LOCALE_COLORMENU_THEMESELECT)
