...
void CServiceMenu::showMenu(void)
{
	...
	else
	{
		...
		// reload Channels
		service->addItem(new CMenuForwarder(_("Reload channel lists"), true, NULL, this, "reloadchannels", RC_nokey, NULL, NEUTRINO_ICON_MENUITEM_RELOADCHANNELS));
		
		// reload EPG
		service->addItem(new CMenuForwarder(_("Reload EPG"), true, NULL, this, "reloadepg", RC_nokey, NULL, NEUTRINO_ICON_MENUITEM_RELOADCHANNELS));
