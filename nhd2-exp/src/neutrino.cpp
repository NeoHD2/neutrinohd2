...
int CNeutrinoApp::loadSetup(const char * fname)
{
	...
	g_settings.menu_Content_blue = configfile.getInt32( "menu_Content_blue", 35);
	...
	g_settings.infobar_blue = configfile.getInt32( "infobar_blue", 35);
	...
	g_settings.menu_FootInfo_green = configfile.getInt32( "menu_FootInfo_green", 10);
	...
	g_settings.menu_FootInfo_Text_red = configfile.getInt32( "menu_FootInfo_Text_red", 95);
	g_settings.menu_FootInfo_Text_green = configfile.getInt32( "menu_FootInfo_Text_green", 70);
	g_settings.menu_FootInfo_Text_blue = configfile.getInt32( "menu_FootInfo_Text_blue", 00);
